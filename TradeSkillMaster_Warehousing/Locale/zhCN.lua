...
L["Enable this to set the stack size multiple to be moved"] = "激活后设置要移动的堆叠倍数"
L["Management"] = "管理"
L["Set Stack Size for bags"] = "设置背包堆叠大小"
L["Stack Size Multiple"] = "堆叠倍数"
L["Warehousing will only move items in multiples of this stack size."] = "Warehousing只会按此堆叠倍数移动物品。"
L["Warehousing will only move items in multiples of the stack size set when moving to your bags, this is useful for milling/prospecting etc to ensure you don't move items you can't process"] = "当向背包移动物品时，Warehousing只会按设置的堆叠倍数移动物品。这对于研磨/勘探等很有用，可以确保您不会移动无法处理的物品。"
