...
L["New Operation"] = "新操作"
L["No auction data found - run the scan again to retry."] = "未读取到该物品的拍卖数据，请重新扫描重试。"
...
L["Above max price. Posting at max price."] = "高于最高价。以最高价发布。"
L["Above max price. Posting at min price."] = "高于最高价。以最低价发布。"
L["Above max price. Posting at normal price."] = "高于最高价。以普通价发布。"
L["At above max price and not undercut."] = "高于最高价且未被压价。"
L["Auctioning could not find %s in your bags so has skipped posting it. Running the scan again should resolve this issue."] = "Auctioning在您的背包中找不到 %s 因此跳过了发布。重新扫描应该可以解决此问题。"
L["Below min price. Posting at max price."] = "低于最低价。以最高价发布。"
L["Below min price. Posting at min price."] = "低于最低价。以最低价发布。"
L["Below min price. Posting at normal price."] = "低于最低价。以普通价发布。"
L["Did not cancel %s because your undercut (%s) is invalid. Check your settings."] = "未取消 %s，因为您的压价值 (%s) 无效。请检查您的设置。"
L["Did not post %s because your undercut (%s) is invalid. Check your settings."] = "未发布 %s，因为您的压价值 (%s) 无效。请检查您的设置。"
L["Did not reset %s because your undercut (%s) is invalid. Check your settings."] = "未重置 %s，因为您的压价值 (%s) 无效。请检查您的设置。"
L["Done Posting\n\nTotal value of your auctions: %s\nIncoming Gold: %s"] = "发布完成\n\n您的拍卖总价值: %s\n预期收入: %s"
L["Done Scanning!\n\nCould potentially reset %d items for %s profit."] = "扫描完成!\n\n潜在可转卖 %d 件物品，预期利润 %s。"
L["How many items you want to keep in your bags and not have Auctioning post."] = "您希望保留在背包中不被Auctioning发布的物品数量。"
L["If checked, a cancel scan will cancel any auctions which have been undercut and are still above your minimum price."] = "如果勾选，取消扫描将取消任何已被压价且仍高于您最低价的拍卖。"
L["Ignore Auctions Below Minimum"] = "忽略低于最低价的拍卖"
L["Keep Quantity"] = "保留数量"
L["Management"] = "管理"
L["Max Inventory Quantity"] = "最大库存数量"
L["Minimum Price"] = "最低价格"
L["None"] = "无"
L["Normal Price"] = "普通价"
L["Play the selected sound when a post / cancel scan is complete and items are ready to be posted / canceled (the gray bar is all the way across).Select None to disable sounds"] = "当发布/取消扫描完成且物品准备好发布/取消时(灰色进度条已满)，播放所选声音。选择'无'以禁用声音。"
L["Price to post at if there are none of an item currently on the AH."] = "如果拍卖行当前没有此物品，发布时使用的价格。"
L["Test Selected Sound"] = "试听所选声音"
L["This dropdown determines what Auctioning will do when the market for an item goes above your maximum price. You can post the items at one of your configured prices."] = "此下拉菜单决定当某物品的市场价高于您设置的最高价时Auctioning的处理方式。您可以以您设置的其中一种价格发布物品。"
L["This dropdown determines what Auctioning will do when the market for an item goes below your minimum price. You can not post the items, post at one of your configured prices, or have Auctioning ignore all the auctions below your minimum price (and likely undercut the lowest auction above your mimimum price)."] = "此下拉菜单决定当某物品的市场价低于您设置的最低价时Auctioning的处理方式。您可以选择不发布、以您设置的其中一种价格发布、或让Auctioning忽略所有低于您最低价的拍卖（并可能压价高于您最低价的最低拍卖）。"
L["This is the maximum quantity of an item you want to buy in a single reset scan."] = "这是单次转卖扫描中您想购买某物品的最大数量。"
L["This is the maximum quantity of an item you want to have in your inventory after a reset scan."] = "这是转卖扫描后您希望库存中保留的某物品最大数量。"
L["WARNING: You minimum price for %s is below its vendorsell price (with AH cut taken into account). Consider raising your minimum price, or vendoring the item."] = "警告: 您为 %s 设置的最低价低于商人收购价(已计入拍卖行抽成)。请考虑提高最低价，或将该物品卖给商人。"
