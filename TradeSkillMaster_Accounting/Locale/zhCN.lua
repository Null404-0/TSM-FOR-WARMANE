...
L["Accounting has not yet collected enough information for this tab. This is likely due to not having recorded enough data points or not seeing any significant fluctuations (over 1k gold) in your gold on hand."] = "Accounting 还没有为此标签页收集到足够的信息。这可能是由于没有记录足够的数据点，或是您持有的金币量没有明显波动（超过 1000 金）。"
...
The x-axis is time and goes from %s to %s
The y-axis is thousands of gold.]=] ] = [=[下图是您的角色金币数量随时间变化的图表。
...
L["Display Money Transfers in Income/Expense/Summary"] = "在 收入/支出/摘要 中显示金币转账"
...
L["If checked, Money Transfers will be included in income / expense and summary. Accounting will still track these if disabled but will not show them."] = "如果勾选，金币转账将计入 收入/支出 和 摘要 中。即使禁用，Accounting 仍会追踪这些数据，但不会显示。"
...
L["Purchased (Avg/Max Price):"] = "购买（均价/最高价）："
...
L["Shift-Right-Click to delete this record."] = "Shift+右键单击 删除该记录。"
...
L["Sold (Avg/Max Price):"] = "售出（均价/最高价）："
...
L["Top Expense by Gold / Quantity:"] = "支出排行（金币/数量）："
L["Top Expense by Quantity:"] = "最高数量支出:"
L["Top Income by Gold:"] = "最高金币收入:"
L["Top Income by Gold / Quantity:"] = "收入排行（金币/数量）："
L["Top Income by Quantity:"] = "最高数量收入:"
L["Top Item by Gold:"] = "最贵物品:"
L["Top Item by Gold / Quantity:"] = "物品排行（金币/数量）："
